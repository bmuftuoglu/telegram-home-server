...
Örneğin ASKİ su kesintisi takibi için:
...
**1.** Servis, durum değiştiğinde gateway'e POST atar:
...
**2.** `docker-compose.yml`'de network'ü external olarak tanımla:
...
**3.** Servis URL'ini `.env`'e ekle, gateway'e komut handler'ı yaz, gateway'i yeniden başlat.
